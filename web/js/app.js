...
(function () {
    ...
    const Gallery = {
        ...
        // داده‌های توضیحات
        descriptions: [
            'اینفوگرافیک مسیر ساخت انیمیشن از ایده تا نمایش نهایی.',
            'روش «اگر... چه می‌شد؟» برای خلق ایده‌های تازه.',
            'کاربرگ ایده‌پردازی برای نوشتن ایده‌های اولیه.',
            'کاربرگ ساخت شخصیت، اتفاق و چالش داستان.',
            'اینفوگرافیک نقش هوش مصنوعی در خلق ایده.',
            'پوستر آموزشی انیمیشن و هوش مصنوعی.',
            'پوستر خلاقیت بی‌پایان در دنیای انیمیشن.'
        ],
